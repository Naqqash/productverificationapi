...
from app.api.controller.verifyproduct import VerifyProduct
...
# from app.core.ResponseSchema import (
...
#         else:
#             status_code = 404
#         response = {"status_code": status_code, "detail": IsVerified}
#         return response

#     except Exception as e:
#         status_code = 400
#         response = {"status_code": status_code, "error": str(e)}
#         return response
...
#                 **{"status_code": status_code, "token": str(token)}
#             )
#             return response
#         else:
#             raise Exception(verification["detail"])
#     except Exception as e:
#         status_code = 400
...
#             **{"status_code": status_code, "records_added": IdsAdded}
#         )
#         return response
#     except Exception as e:
#         status_code = 400
